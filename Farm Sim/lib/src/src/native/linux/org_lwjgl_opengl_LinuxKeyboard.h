...
#undef org_lwjgl_opengl_LinuxKeyboard_KeyPress
#define org_lwjgl_opengl_LinuxKeyboard_KeyPress 2L
#undef org_lwjgl_opengl_LinuxKeyboard_KeyRelease
#define org_lwjgl_opengl_LinuxKeyboard_KeyRelease 3L
