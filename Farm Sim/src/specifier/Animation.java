...
public class Animation
{
	 ...
	 * @param length ( total length, in milliseconds of, animation  )
	 * @param Anim ( array of texture files *no nulls* )
	 */
	...
	/**
	 * Overloaded animation object creation with separate frame times --
	 * times and anim must be the same size!
	 * @param length ( total length, in milliseconds, of animation )
	 * @param times ( integer array of each frame time )
	 * @param anim ( array of texture files * no nulls *
	 */
	 ...
	 * @param Sc ( factor by which to scale animation speed )
	 */
