...
public class Game
{
	...
	private void InitializeVariables()
	{
		...
		GameVariables.Set(new object.Variable("m_width", "maximum width (in tiles ) of map", 20, 1, 1000, object.Variable.Flag.Latched));
		GameVariables.Set(new object.Variable("m_height", "maximum height (in tiles ) of map", 20, 1, 1000, object.Variable.Flag.Latched));	
